  ...
  return (
    <React.Fragment>
      <div className='container'>
        ...
        <br />
        <br />
        {message && <label style={{ background: 'lightgreen' }}>{message}</label>}
        <br />
        <button style={{ background: 'red' }} type='submit' onClick={handleReset}>
          Reset
        </button>
        <a href='https://github.com/Bilal-Bangash' target='_blank' rel='noopener noreferrer'>
